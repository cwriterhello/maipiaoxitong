...
<font style="color:rgb(51, 51, 51);">本文将介绍大麦网中的数据库表的设计，包括表结构、表之间的关联关系</font>

## <font style="color:rgb(51, 51, 51);">基础数据服务</font>
**<font style="color:rgb(51, 51, 51);">d_channel_data</font>**
...
**<font style="color:rgb(51, 51, 51);">d_area</font>**
...
### <font style="color:rgb(51, 51, 51);">表关系</font>
![1728109171052-7a35f29c-8555-41ff-a951-1fe9aa90797f.png](./img/KJnNY_acgKzx_gmg/1728109171052-7a35f29c-8555-41ff-a951-1fe9aa90797f-223470.png)

## <font style="color:rgb(51, 51, 51);">用户服务</font>
**<font style="color:rgb(51, 51, 51);">d_user 用户表</font>**
...
**<font style="color:rgb(51, 51, 51);">d_user_mobile 用户手机表</font>**
...
**<font style="color:rgb(51, 51, 51);">d_user_email 用户邮箱表</font>**
...
**<font style="color:rgb(51, 51, 51);">d_ticket_user 购票人表</font>**
...
<font style="color:rgb(51, 51, 51);">单独设计出 </font>**<font style="color:rgb(51, 51, 51);">d_user_mobile 用户手机表</font>**<font style="color:rgb(51, 51, 51);"> 和 </font>**<font style="color:rgb(51, 51, 51);">d_user_email 用户邮箱表</font>**<font style="color:rgb(51, 51, 51);"> 是因为用户登录时，可以使用手机号或者邮箱登录，而用户表在分库分表时，选择的分片键是用户id，所以要设计出这两张表，根据手机号或者邮箱查询到用户id，然后使用用户id查询用户信息</font>

### <font style="color:rgb(51, 51, 51);">表关系</font>
![1728109179160-47d1a6c1-85f5-45d4-a54a-32905caea592.png](./img/KJnNY_acgKzx_gmg/1728109179160-47d1a6c1-85f5-45d4-a54a-32905caea592-640989.png)

## <font style="color:rgb(51, 51, 51);">节目服务</font>
**<font style="color:rgb(51, 51, 51);">d_program 节目表</font>**
...
**<font style="color:rgb(51, 51, 51);">d_program_group 节目分组表</font>**
...
**<font style="color:rgb(51, 51, 51);">d_program_category 节目类型表</font>**
...
**<font style="color:rgb(51, 51, 51);">d_program_show_time 节目演出时间表</font>**
...
**<font style="color:rgb(51, 51, 51);">d_ticket_category 节目票档表</font>**
...
**<font style="color:rgb(51, 51, 51);">d_seat</font>**
...
### <font style="color:rgb(51, 51, 51);">表关系</font>
![1728109209086-667ffd5a-2481-4ca5-ad6c-642cf31196b7.png](./img/KJnNY_acgKzx_gmg/1728109209086-667ffd5a-2481-4ca5-ad6c-642cf31196b7-070252.png)

## <font style="color:rgb(51, 51, 51);">订单服务</font>
**<font style="color:rgb(51, 51, 51);">d_order</font>**
...
**<font style="color:rgb(51, 51, 51);">d_order_ticket_user</font>**
...
### <font style="color:rgb(51, 51, 51);">表关系</font>
![1728109214260-62620645-bbcc-49d8-bf9d-5bd960a43780.png](./img/KJnNY_acgKzx_gmg/1728109214260-62620645-bbcc-49d8-bf9d-5bd960a43780-781779.png)

## <font style="color:rgb(51, 51, 51);">支付服务</font>
**<font style="color:rgb(51, 51, 51);">d_pay_bill</font>**
...
**<font style="color:rgb(51, 51, 51);">d_refund_bill</font>**
...
![1728109219603-b8f7c546-0446-4db9-8379-33a1866ae7b1.png](./img/KJnNY_acgKzx_gmg/1728109219603-b8f7c546-0446-4db9-8379-33a1866ae7b1-676569.png)

## <font style="color:rgb(51, 51, 51);">定制化服务</font>
**<font style="color:rgb(51, 51, 51);">d_rule</font>**
...
**<font style="color:rgb(51, 51, 51);">d_depth_rule</font>**
...
**<font style="color:rgb(51, 51, 51);">d_api_data</font>**
...
### <font style="color:rgb(51, 51, 51);">表关系</font>
![1728109223439-c08064f5-23b8-4103-b94d-b9c7892b88bd.png](./img/KJnNY_acgKzx_gmg/1728109223439-c08064f5-23b8-4103-b94d-b9c7892b88bd-409554.png)
